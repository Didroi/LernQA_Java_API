...
public class UserAuthTest {
    ...
    public void testAuthUser() {
        ...
        assertTrue(cookies.containsKey("auth_sid"), "Response doesn't contain \"auth_sid\" cookie");
        assertTrue(headers.hasHeaderWithName("x-csrf-token"), "Response doesn't contain \"x-csrf-token\" cookie");
        ...
        assertEquals(
                userIdOnAuth,
                userIdOnCheck,
                "user id from auth is not equal to user id from check request"
        );
    }
